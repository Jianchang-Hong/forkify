...
export const loadRecipe = async function (id) {
  try {
    ...
    // console.log('load', state.bookmarks);
    // if (state.bookmarks) {
    //   state.bookmarks.forEach(bk => {
    //     if (bk.id === state.recipe.id) {
...
export const loadSearchResults = async function (query) {
  try {
    ...
    // state.recipes = recipes.map(obj => {
    //   const { image_url, ...rest } = obj;
    //   return { imageUrl: image_url, ...rest };
    // });
...
// export const minusBookmark = function (recipe) {
//   console.log('beforeminus', state.bookmarks);
//   state.bookmarks = state.bookmarks.filter(obj => obj.id !== recipe.id);
//   if (recipe.id === state.recipe.id) state.recipe.bookmarked = false;
//   console.log('minusresult', state.recipe);
//   console.log('minusbookmarks', state.bookmarks);
// };
